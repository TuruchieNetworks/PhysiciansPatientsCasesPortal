	...
	<div class="container" style=" text-align:center;">
		...
		<div class="row">
	    	...
	    	<a href="/mellowHealth/patientsPortal/patients/${patient.id}" style="width: 100%; display:block; padding:10px;color:brown;text-decoration:none;background:rgba(2.11, 24.5, 1.21, 0.9);border-radius:5%;font-weight:bold;font-size:22px;padding:10px;font-family:cursive;text-align:center;">
				<h1 style="color:azure;border-bottom: 2px solid aliceblue;background:rgba(2.11, 24.5, 1.21, 0.9);border-radius:5%;font-weight:bold;font-size:22px;padding:10px;font-family:cursive;text-align:center;">Edit Your Profile ${patient.patientFirstName}!</h1>		
	    	</a>
	    		<form:form action="/mellowHealth/patientsPortal/process/patients/editPatient/${patient.id}" method="PATCH" modelAttribute="patient">
				    ...
				    <div class="form-group">
				        ...
				        <form:input path="confirmPassword" class="form-control" value="${confirmPatientPassword}" placeholder="Please Confirm Password!" />
				    ...
				    <h1 style="background:rgba(6.8, 0.8, 0.320, 0.9);width:100%; padding: 10px; border-radius:5%;margin:5px 0"><input type="submit" value="Edit Mellow Health Account!" class="btn btn-success" style="margin: 10px 0; width: 100%; padding: 10px;font-size:22px;"/></h1>
				</form:form>
				<a style="background:rgba(6.8, 1.8, 20, 0.9);margin:10px 0;width:100%; display:block; padding: 10px;border-radius:5%;" href="/mellowHealth/patientsPortal/patients" class="btn btn-success"><h1 style="color:azure;border-bottom: 2px solid aliceblue;background:rgba(112.11, 24.5, 1, 0.9);border-radius:5%;font-weight:bold;font-size:20px;padding:10px;font-family:cursive;text-align:center;">GO BACK</h1></a>
