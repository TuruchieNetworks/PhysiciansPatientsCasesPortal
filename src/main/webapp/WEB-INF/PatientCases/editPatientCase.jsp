...
<title>Edit Patient Visit!</title>
</head>
<body class="container-fluid p-6"  style="background:khaki;font-family:cursive;">
	...
	<div class="container-fluid p-6" style=" text-align:center;">
		<a style="width: 100%; display:block; padding:0px;color:brown;text-decoration:none;" href="/mellowHealth/physicians/${loggedInPhysician.id }">
			<h1 style="color:azure;border-bottom:2px solid aliceblue;background:rgba(2.11, 24.5, 121, 0.9);border-radius:5%;font-weight:bold;font-size:22px;padding:10px;font-family:cursive;text-align:center;">Make Changes On Your ${createdAt} Submitted Visit Today, <c:out value="Dr. ${loggedInPhysician.firstName}  ${dayCurrentDate}"/></h1>
		</a>
		<div class="row">
			...
			<div class="col">
				...
				<!--form:errors path="*" cssClass="text-danger"/!-->
				    ...
				    <input type="submit" value="Update Patient Case" class="btn btn-success" style="margin: 10px 0; width: 100%; padding: 10px;"/>
				</form:form>
